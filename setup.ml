...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7bb827cc0bb9cd7c4bfd185de5fbbc36) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Game logic for the Container board game";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\015\bT4\244\232\005\029\155\168\180\021%\150]\242";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
